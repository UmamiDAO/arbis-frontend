...
export default function STArbisUI(props) {
  ...
  const { provider, userSigner, address, tx, injectedProvider, farmAddress, warning, hideDeposit } = props;
        ...
        <div>
          <Layout>
            <Content className="farm">
              ...
              Stake your {showSymbol()} for ${name ? name : ""} to earn passive $ETH generated by Arbi's autocompounding strategies automatically!
              <p className="tvl">
              ...
              <div className="action-box">
                ...
                <Hint
                  hint={
                    <span>
                      When you withdraw any pending ETH will be paid out to your address automatically.
                    </span>
                  }
                />
              </div>
